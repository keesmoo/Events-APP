...
class UpcomingEventsAdapter(private val onClick: (ListEventsItem) -> Unit) : ListAdapter<ListEventsItem, UpcomingEventsAdapter.EventViewHolder>(EventDiffCallback()) {
